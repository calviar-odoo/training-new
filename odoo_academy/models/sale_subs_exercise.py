...
class SaleSubsExercise(models.Model):
    ...
    def prepare_invoice_extra_line(self, line, fiscal_position, date_start=False, date_stop=False):
    ...
    def prepare_invoice_lines(self, fiscal_position):
        self.ensure_one()
        ...
        return [(0, 0, self.prepare_invoice_extra_line(line, fiscal_position, revenue_date_start, revenue_date_stop)),
