...
class Session(models.Model):
    ...
    course_id = fields.Many2one(comodel_name='academy.course.cesar',
                                string='Course',
                                ondelete='cascade',
                                required=True)
    
    name = fields.Char(string='Title', related='course_id.name') # Enlace al modelo course.py
    ...
    end_date = fields.Date(string='End Date',
                          compute="_compute_end_date", # Cambiar comillas
